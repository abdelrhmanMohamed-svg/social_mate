  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<PostCubit, PostState>(
      ...
      buildWhen: (previous, current) =>
          (current is ToggleLikePostLoading && current.postId == post.id) ||
          (current is ToggleLikePostSuccess && current.postId == post.id) ||
        ...
        return Row(
          children: [
            InkWell(
              ...
              child: Icon(
                (state is ToggleLikePostSuccess ? state.isLiked : post.isLiked)
                    ? Icons.thumb_up
